...
def load_models():
    ...
    processor1 = AutoImageProcessor.from_pretrained(model_name1, cache_dir = model_path, local_files_only=True)
    model1 = AutoModelForImageClassification.from_pretrained(model_name1, cache_dir = model_path, local_files_only=True)
    ...
    processor2 = AutoImageProcessor.from_pretrained(model_name2, cache_dir=model_path, local_files_only=True)
    model2 = AutoModelForImageClassification.from_pretrained(model_name2, cache_dir=model_path, local_files_only=True)
    ...
    processor3 = AutoImageProcessor.from_pretrained(model_name3, cache_dir=model_path, local_files_only=True)
    model3 = AutoModelForImageClassification.from_pretrained(model_name3, cache_dir=model_path, local_files_only=True)
    ...
    processor4 = AutoImageProcessor.from_pretrained(model_name4, cache_dir=model_path, local_files_only=True)
    model4 = AutoModelForImageClassification.from_pretrained(model_name4, cache_dir=model_path, local_files_only=True)
